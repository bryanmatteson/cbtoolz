...
import cbtoolz
from cbtoolz.hashutils import file_hash, stable_hash, to_qualified_name
...
@pytest.mark.parametrize(
    "obj,expected",
    [
        (to_qualified_name, "cbtoolz.hashutils.to_qualified_name"),
        (cbtoolz.awsutils.AwsSigV4Auth, "cbtoolz.awsutils.AwsSigV4Auth"),
        (lambda x: x + 1, "tests.test_hashing.<lambda>"),
        (my_fn, "tests.test_hashing.my_fn"),
    ],
)
